...
public class RedSpike extends Enemy{

private BufferedImage[] sprites;

    public RedSpike(TileMap tm){
        super(tm);
        ...
        try {
            ...
            BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/RedSpike.png"));
